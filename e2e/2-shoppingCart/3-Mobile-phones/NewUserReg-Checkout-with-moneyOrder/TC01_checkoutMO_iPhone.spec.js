...
import {newUserRegistrationMO} from "../../../../utils/checkoutActions/regUser-moneyOrder.js"
...
test('TC01-Apple iPhone 16 128GB', async({page}) => {
    ...
    await page.locator('#add-to-cart-button-21').click();
    ...
    await newUserRegistrationMO(page)
});